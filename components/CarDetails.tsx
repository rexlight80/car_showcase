             ...
             <div className='fixed inset-0 overflow-y-auto'>
                ...
                <Transition.Child
                   ...
                   leaveTo='opacity-0 scale-95'>
                     ...
                     transform rounded-2xl bg-white text-left shadow-xl p-6 translate-all flex flex-col gap-5">
                        <button 
                          type='button'
                           ...
                           <div className='mt-3 flex flex-wrap gap-4'>
                                {
                                 ...
                                 <div className='flex justify-between gap-5 w-full tetx-right' key={key}>
